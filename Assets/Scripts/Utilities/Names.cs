...
public static class Names {
    ...
    public const string PLAYER_PELOTON = "PlayerPeloton";
    public const string ENEMY_PELOTON = "EnemyPeloton";
    public const string PLAYER_LEADER_PELOTON = "PlayerLeaderPeloton";
    public const string ENEMY_LEADER_PELOTON = "EnemyLeaderPeloton";
